...
This project was generated with MVPKit Core: an opinionated TypeScript monorepo for building on [Cloudflare](https://www.cloudflare.com).
...
- `packages/types`: shared schemas and frontend-safe DTOs
...
The setup script is safe to rerun; it creates missing Cloudflare resources and prints existing IDs when resources already exist.
...
Focused deploys live in the owning workspaces:

- `cd services/api && bun run deploy`
