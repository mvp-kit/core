<!-- Generated by docs/scripts/context-sync.mjs. Do not edit manually. -->
...
Better Auth powered auth flows with app-level sign in/up components.
...
R2-backed upload and list operations exposed via tRPC.
...
Authenticated app shell and baseline user profile contract.
